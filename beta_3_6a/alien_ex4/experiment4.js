...
const prolificID = {
    ...
    const refPhase1 = [
        test1Indices.slice(0, 4)
    ];
    const refPhase2 = [
        test2Indices.slice(0, 4)
    ];
    const refPhase3 = [
            ...
            saveData(withdrawnFilename, finalJson)
                .then(() => {
                    ...
                    showBlankScreen().then(() => {
                        ...
                        window.location.href = "https://app.prolific.com/submissions/complete?cc=C13XD4G3";
                    });
                })
                .catch(error => {
	...
	trainTitle(2), trainInstructions, ...train3,
	testTitle(2), testInstructions
    ];
    ...
    await safeRun([
        optionalBreak, checkWithdraw, extraBlank,
	trainTitle(3), trainInstructions, ...train4,
        testTitle(3), testInstructions, ...test4,
